...
% where:
\begin{itemize}
    \item Real v Nominal Prices - real have been adjusted to a particular year to remove the impact of inflation
...
\begin{itemize}
    \item Supply Curve, Demand Curve - quantity supplied and demanded at a given price
    \item Market mechanism and equilibrium price and quantity - pressure to gravitate to a point where supply and demand quantity are equal
    \item Elasticity in general - sensitivity of a variable to change in another variable.
    \item Substitute goods - price increase in one produces increase in demand for the other
    \item Complementary goods - price increase in one produces decrease in demand for the other
\end{itemize}
